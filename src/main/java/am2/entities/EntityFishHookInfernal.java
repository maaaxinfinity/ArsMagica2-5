...
public class EntityFishHookInfernal extends EntityFishHook {
    ...
    public static final List nether_fishing = Arrays.asList(new WeightedRandomFishable[] {new WeightedRandomFishable(new ItemStack(Items.nether_wart), 10), new WeightedRandomFishable(new ItemStack(Items.blaze_powder), 10), new WeightedRandomFishable(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_HELLFISH), 5), new WeightedRandomFishable(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_PYROGENICSEDIMENT), 10), new WeightedRandomFishable(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SUNSTONEFRAGMENT), 5), new WeightedRandomFishable(new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_FIRE), 5), new WeightedRandomFishable(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_ARCANEASH), 5)});
    ...
    public void onUpdate()
    {
        ...
        else
        {
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.field_146042_b.isDead || !this.field_146042_b.isEntityAlive() || itemstack == null || itemstack.getItem() != ItemsCommonProxy.itemInfernalFishingRod || this.getDistanceSqToEntity(this.field_146042_b) > 1024.0D)
                {
                    this.setDead();
                    ...
                    else
                    {
                        ...
                        if (this.field_146038_az > 0)
                        {
                            ...
                            if (this.field_146038_az <= 0)
                            {
                                ...
                                worldserver.func_147487_a("dripLava", this.posX, (double)(f1 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D);
                                worldserver.func_147487_a("reddust", this.posX, (double)(f1 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D);
                            ...
                            else
                            {
                                ...
                                {
                                    worldserver.func_147487_a("dripLava", d11, d5 - 0.10000000149011612D, d6, 1, (double)f7, 0.1D, (double)f2, 0.0D);
                                }

                                float f3 = f7 * 0.04F;
                                float f4 = f2 * 0.04F;
                                worldserver.func_147487_a("reddust", d11, d5, d6, 0, (double)f4, 0.01D, (double)(-f3), 1.0D);
                                worldserver.func_147487_a("reddust", d11, d5, d6, 0, (double)(-f4), 0.01D, (double)f3, 1.0D);
                            }
                        }
                        else if (this.field_146040_ay > 0)
                        {
                            ...
                            if (this.rand.nextFloat() < f1)
                            {
                                ...
                                worldserver.func_147487_a("flame", d11, d5, d6, 2 + this.rand.nextInt(2), 0.10000000149011612D, 0.0D, 0.10000000149011612D, 0.0D);
                            }
    ...
    private ItemStack getItemToGive()
    {
        if (field_146042_b.worldObj.provider.dimensionId == -1) { // nether lava
            ...
            return rand.nextBoolean() ? new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_PYROGENICSEDIMENT) : new ItemStack(Items.blaze_powder);
        }
